...
class Player(BasePlayer):
    ...
    shock_belief = models.StringField(
        label="Please state how believable was the information you were provided",
        choices=["Not believable at all", "Hard to believe", "Quite believable", "Very believable", "Prefer not ot say"])