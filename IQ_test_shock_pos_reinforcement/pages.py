...
class SurveyQuestions(Page):
    form_model = "player"
    form_fields = ["gender", "age", "education", "employment", "marriage", "shock_belief"]
...
page_sequence = [Instructions, IQ_test1, IQ_test2, IQ_test3, IQ_test4, IQ_test5, IQ_test6,
                 ...
                 Likelihood1, Possitive_EU, Feedback, Confirm, Likelihood2, Results, SurveyQuestions, ]
