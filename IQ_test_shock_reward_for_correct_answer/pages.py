...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        if self.player.rank <= 5:
            self.player.payoff1 = Constants.fix_payment + Constants.payment_per_correct_answer * self.player.combined_score - Constants.variable_payment_coef * (1 - (self.player.likelihood1 / 100)) * (1 - (self.player.likelihood1 / 100))
            self.player.payoff2 = Constants.fix_payment + Constants.payment_per_correct_answer * self.player.combined_score - Constants.variable_payment_coef * (1 - (self.player.likelihood2 / 100)) * (1 - (self.player.likelihood2 / 100))
        else:
            self.player.payoff1 = Constants.fix_payment + Constants.payment_per_correct_answer * self.player.combined_score - Constants.variable_payment_coef * (0 - (self.player.likelihood1 / 100)) * (0 - (self.player.likelihood1 / 100))
            self.player.payoff2 = Constants.fix_payment + Constants.payment_per_correct_answer * self.player.combined_score - Constants.variable_payment_coef * (0 - (self.player.likelihood2 / 100)) * (0 - (self.player.likelihood2 / 100))
